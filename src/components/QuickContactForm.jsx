  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await notifyTelegram({
        ...
        message: 'Быстрая заявка из Header',
      });
          ...
          {status === 'success' ? (
            <div className="quick-contact-form__success">
              <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                <circle cx="24" cy="24" r="20" stroke="var(--success)" strokeWidth="2" />
                <path
                  d="M16 24l6 6 10-12"
                  stroke="var(--success)"
                  strokeWidth="2"
            ...
            <>
              <div className="quick-contact-form__header">
                ...
                <p>Оставьте контакты — перезвоним за 5 минут</p>
              </div>

              <form onSubmit={handleSubmit} className="quick-contact-form__form">
                <div className="quick-contact-form__field">
                  ...
                  />
                  {errors.name && (
                    <span className="quick-contact-form__error">{errors.name}</span>
                  )}
                </div>
                ...
                <div className="quick-contact-form__field">
                  ...
                  />
                  {errors.phone && (
                    <span className="quick-contact-form__error">{errors.phone}</span>
                  )}
                </div>
